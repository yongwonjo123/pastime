...
function setRepeatCycle() {
    let start = new Date($('#startDate').val());
 	console.log("온오프 = " + $('#startDate').val());
    let end = new Date($('#endDate').val());
 	console.log("온오프 = " + $('#endDate').val());
    // 매주
...
function placeSelected() {
    ...
    let placeFormatted = document.getElementById("placeFormatted");

    placeName.value = document.getElementById("place-name").innerText;
    placeId.value = document.getElementById("place-id").innerText;
    placeFormatted.value = document.getElementById("place-formatted").innerText;

    // placeResult 보여주기
    $('#placeName').removeAttr("hidden");
    $('#placeFormatted').removeAttr("hidden");
